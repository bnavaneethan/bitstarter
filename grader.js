...
var URL_DEFAULT = "http://nameless-garden-9179.herokuapp.com/";
...
var cheerioUrlStr = function(urlStr) {
    return cheerio.load(fs.readFileSync(urlStr));
};
...
var checkHeroku = function(htmlfile, checksfile) {
	...
	rest.get(URL_DEFAULT).on('complete', response2Console);
};
